...
The companion repository is the book's own source repository:

<https://github.com/data-for-good-concepts/introduction-to-modern-statistics-for-football-scouting>

Two routes to it, identical in result: on that page, *Code > Download ZIP*, then unzip the folder somewhere permanent (feel free to rename it to something shorter); or, if you use git, clone the URL.
The repository also contains the book's full text — the `data/` folder inside is all the chapters ever read.
...
This appendix is original to this adaptation, licensed CC BY-SA 4.0. Match data: [StatsBomb open data](https://github.com/statsbomb/open-data) (CC BY-NC-SA 4.0).
