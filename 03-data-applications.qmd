...
The `wc2022_shots` and `weuro2025_shots` data are stored as CSV files in `data/derived/`, built from [StatsBomb open data](https://github.com/statsbomb/open-data) via `scripts/derive_statsbomb_tables.py`.
